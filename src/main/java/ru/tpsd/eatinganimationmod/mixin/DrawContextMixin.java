...
public abstract class DrawContextMixin {
	...
	public BakedModel getHeldItemModel(ItemStack stack, @Nullable World world, @Nullable LivingEntity entity, int seed) {
		...
		BakedModel bakedModel1 = stack.isFood() ? client.getItemRenderer().getModels().getModel(stack) : bakedModel.getOverrides().apply(bakedModel, stack, clientWorld, entity, seed);
